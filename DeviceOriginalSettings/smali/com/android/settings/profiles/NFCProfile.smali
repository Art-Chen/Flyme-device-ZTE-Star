...
.method private getPreviouslySelectedProfile()Landroid/app/Profile;
    ...
    .line 136
    iget-object v3, p0, Lcom/flyme/DeviceOriginalSettings/profiles/NFCProfile;->mProfileManager:Landroid/app/ProfileManager;
...
.method private handleProfileMimeType([B)V
    ...
    .line 93
    iget-object v6, p0, Lcom/flyme/DeviceOriginalSettings/profiles/NFCProfile;->mProfileManager:Landroid/app/ProfileManager;
    ...
    invoke-virtual {v6, v4}, Landroid/app/ProfileManager;->getProfile(Ljava/util/UUID;)Landroid/app/Profile;

    move-result-object v5

    .line 96
    .local v5, "targetProfile":Landroid/app/Profile;
    if-nez v5, :cond_2
    ...
    .line 116
    .end local v0    # "currentProfile":Landroid/app/Profile;
    .end local v2    # "i":Landroid/content/Intent;
    .end local v5    # "targetProfile":Landroid/app/Profile;
    :cond_0
    :goto_1
    return-void
    ...
    .line 104
    .restart local v0    # "currentProfile":Landroid/app/Profile;
    .restart local v1    # "enabled":Z
    .restart local v5    # "targetProfile":Landroid/app/Profile;
    :cond_2
    if-eqz v0, :cond_3
    ...
    .line 108
    :cond_4
    invoke-direct {p0}, Lcom/flyme/DeviceOriginalSettings/profiles/NFCProfile;->getPreviouslySelectedProfile()Landroid/app/Profile;

    move-result-object v3

    .line 109
    .local v3, "lastProfile":Landroid/app/Profile;
    if-eqz v3, :cond_0
...
.method private saveCurrentProfile()V
    ...
    .prologue
    .line 148
    iget-object v2, p0, Lcom/flyme/DeviceOriginalSettings/profiles/NFCProfile;->mProfileManager:Landroid/app/ProfileManager;
...
.method private switchTo(Ljava/util/UUID;)V
    ...
    .line 119
    iget-object v1, p0, Lcom/flyme/DeviceOriginalSettings/profiles/NFCProfile;->mProfileManager:Landroid/app/ProfileManager;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/flyme/DeviceOriginalSettings/profiles/NFCProfile;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/app/ProfileManager;

    iput-object v0, p0, Lcom/flyme/DeviceOriginalSettings/profiles/NFCProfile;->mProfileManager:Landroid/app/ProfileManager;
