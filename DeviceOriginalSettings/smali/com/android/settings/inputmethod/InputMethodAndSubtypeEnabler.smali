...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mAutoSelectionPrefsMap:Ljava/util/HashMap;

    return-void
.end method

.method static synthetic access$000(Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;)Ljava/text/Collator;
    .locals 1
    .param p0, "x0"    # Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;

    .prologue
    .line 44
    iget-object v0, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mCollator:Ljava/text/Collator;
...
.method private addInputMethodSubtypePreferences(Landroid/view/inputmethod/InputMethodInfo;Landroid/preference/PreferenceScreen;)V
    ...
    .line 170
    new-instance v3, Lcom/flyme/DeviceOriginalSettings/inputmethod/SwitchWithNoTextPreference;

    invoke-direct {v3, v5}, Lcom/flyme/DeviceOriginalSettings/inputmethod/SwitchWithNoTextPreference;-><init>(Landroid/content/Context;)V

    .line 171
    .local v3, "autoSelectionPref":Landroid/preference/TwoStatePreference;
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mAutoSelectionPrefsMap:Ljava/util/HashMap;
    ...
    .line 189
    :cond_2
    new-instance v15, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodSubtypePreference;

    move-object/from16 v0, p1

    invoke-direct {v15, v5, v13, v0}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodSubtypePreference;-><init>(Landroid/content/Context;Landroid/view/inputmethod/InputMethodSubtype;Landroid/view/inputmethod/InputMethodInfo;)V
    ...
    :cond_3
    new-instance v17, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler$1;

    move-object/from16 v0, v17

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler$1;-><init>(Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;)V
    ...
    .line 208
    invoke-static {v11}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->removeUnnecessaryNonPersistentPreference(Landroid/preference/Preference;)V
...
.method private isNoSubtypesExplicitlySelected(Ljava/lang/String;)Z
    ...
    .prologue
    .line 220
    iget-object v3, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mInputMethodAndSubtypePrefsMap:Ljava/util/HashMap;
...
.method private setAutoSelectionSubtypesEnabled(Ljava/lang/String;Z)V
    ...
    .line 231
    iget-object v4, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mAutoSelectionPrefsMap:Ljava/util/HashMap;
    ...
    iget-object v6, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mInputMethodInfoList:Ljava/util/List;

    iget-boolean v7, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mHaveHardKeyboard:Z

    invoke-static {p0, v4, v6, v7}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->saveInputMethodSubtypeList(Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Z)V

    .line 251
    invoke-direct {p0, p1, v5}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->updateImplicitlyEnabledSubtypes(Ljava/lang/String;Z)V
...
.method private updateAutoSelectionPreferences()V
    ...
    invoke-direct {p0, v1, v2}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->setAutoSelectionSubtypesEnabled(Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, v2, v3}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->updateImplicitlyEnabledSubtypes(Ljava/lang/String;Z)V
...
.method private updateImplicitlyEnabledSubtypes(Ljava/lang/String;Z)V
    ...
    .prologue
    .line 257
    iget-object v4, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mInputMethodInfoList:Ljava/util/List;
    ...
    .line 266
    :cond_1
    invoke-direct {p0, v2, p2}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->updateImplicitlyEnabledSubtypesOf(Landroid/view/inputmethod/InputMethodInfo;Z)V
...
.method private updateImplicitlyEnabledSubtypesOf(Landroid/view/inputmethod/InputMethodInfo;Z)V
    ...
    iget-object v9, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mInputMethodAndSubtypePrefsMap:Ljava/util/HashMap;
    ...
    iget-object v9, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mImm:Landroid/view/inputmethod/InputMethodManager;
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v1}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->getStringExtraFromIntentOrArguments(Ljava/lang/String;)Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v6}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Landroid/view/inputmethod/InputMethodManager;

    iput-object v6, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mImm:Landroid/view/inputmethod/InputMethodManager;
    ...
    :goto_0
    iput-boolean v6, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mHaveHardKeyboard:Z

    .line 66
    const-string v6, "input_method_id"

    invoke-direct {p0, v6}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->getStringExtraFromIntentOrArguments(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    .line 69
    .local v5, "targetImi":Ljava/lang/String;
    iget-object v6, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mImm:Landroid/view/inputmethod/InputMethodManager;

    invoke-virtual {v6}, Landroid/view/inputmethod/InputMethodManager;->getInputMethodList()Ljava/util/List;

    move-result-object v6

    iput-object v6, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mInputMethodInfoList:Ljava/util/List;
    ...
    iput-object v6, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mCollator:Ljava/text/Collator;

    .line 72
    invoke-virtual {p0}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->getPreferenceManager()Landroid/preference/PreferenceManager;
    ...
    .line 78
    :cond_0
    invoke-direct {p0, v1, v4}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->addInputMethodSubtypePreferences(Landroid/view/inputmethod/InputMethodInfo;Landroid/preference/PreferenceScreen;)V
    ...
    :cond_3
    invoke-virtual {p0, v4}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->setPreferenceScreen(Landroid/preference/PreferenceScreen;)V
...
.method public onPause()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->updateImplicitlyEnabledSubtypes(Ljava/lang/String;Z)V
    ...
    iget-object v1, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mInputMethodInfoList:Ljava/util/List;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v7, p0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->mAutoSelectionPrefsMap:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v2, v5}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->setAutoSelectionSubtypesEnabled(Ljava/lang/String;Z)V
    ...
    :cond_3
    instance-of v7, p1, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodSubtypePreference;
    ...
    .line 142
    check-cast v4, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodSubtypePreference;

    .line 143
    .local v4, "subtypePref":Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodSubtypePreference;
    invoke-virtual {v4, v3}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodSubtypePreference;->setChecked(Z)V

    .line 144
    invoke-virtual {v4}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodSubtypePreference;->isChecked()Z
    ...
    .line 147
    invoke-direct {p0}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeEnabler;->updateAutoSelectionPreferences()V
