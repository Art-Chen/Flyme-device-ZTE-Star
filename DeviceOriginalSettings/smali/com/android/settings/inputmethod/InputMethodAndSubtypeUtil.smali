.class Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    sput-object v0, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSubtypeSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method static enableInputMethodSubtypesOf(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/util/HashSet;)V
    ...
    invoke-static {p0}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->getEnabledInputMethodsAndSubtypeList(Landroid/content/ContentResolver;)Ljava/util/HashMap;
    ...
    .line 140
    invoke-static {v0}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->buildInputMethodsAndSubtypesString(Ljava/util/HashMap;)Ljava/lang/String;
...
.method private static getDisabledSystemIMEs(Landroid/content/ContentResolver;)Ljava/util/HashSet;
    ...
    .line 153
    :cond_1
    sget-object v2, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method private static getEnabledInputMethodsAndSubtypeList(Landroid/content/ContentResolver;)Ljava/util/HashMap;
    ...
    invoke-static {v0}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->parseInputMethodsAndSubtypesString(Ljava/lang/String;)Ljava/util/HashMap;
...
.method private static isInputMethodSubtypeSelected(Landroid/content/ContentResolver;)Z
    ...
    .prologue
    .line 94
    invoke-static {p0}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->getInputMethodSubtypeSelected(Landroid/content/ContentResolver;)I
...
.method static loadInputMethodSubtypeList(Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Ljava/util/Map;)V
    .locals 10
    .param p0, "context"    # Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;
    .param p1, "resolver"    # Landroid/content/ContentResolver;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;",
            "Landroid/content/ContentResolver;",
            "Ljava/util/List",
            "<",
    ...
    invoke-static {p1}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->getEnabledInputMethodsAndSubtypeList(Landroid/content/ContentResolver;)Ljava/util/HashMap;
    ...
    :cond_1
    invoke-static {p0, p2, v5, v6}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->setSubtypesPreferenceEnabled(Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;Ljava/util/List;Ljava/lang/String;Z)V
    ...
    :cond_2
    invoke-static {p0, p2, v1}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->updateSubtypesPreferenceChecked(Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;Ljava/util/List;Ljava/util/HashMap;)V
...
.method static parseInputMethodsAndSubtypesString(Ljava/lang/String;)Ljava/util/HashMap;
    ...
    .line 118
    :cond_1
    sget-object v4, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
    ...
    sget-object v4, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->sStringInputMethodSubtypeSplitter:Landroid/text/TextUtils$SimpleStringSplitter;
...
.method static saveInputMethodSubtypeList(Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Z)V
    .locals 25
    .param p0, "context"    # Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;
    .param p1, "resolver"    # Landroid/content/ContentResolver;
    ...
    invoke-static/range {p1 .. p1}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->getInputMethodSubtypeSelected(Landroid/content/ContentResolver;)I

    move-result v15

    .line 166
    .local v15, "selectedInputMethodSubtype":I
    invoke-static/range {p1 .. p1}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->getEnabledInputMethodsAndSubtypeList(Landroid/content/ContentResolver;)Ljava/util/HashMap;
    ...
    invoke-static/range {p1 .. p1}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->getDisabledSystemIMEs(Landroid/content/ContentResolver;)Ljava/util/HashSet;
    ...
    invoke-virtual {v0, v10}, Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;->getActivity()Landroid/app/Activity;

    move-result-object v23

    invoke-static/range {v23 .. v23}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodSettingValuesWrapper;->getInstance(Landroid/content/Context;)Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodSettingValuesWrapper;
    ...
    invoke-virtual {v0, v9, v1}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodSettingValuesWrapper;->isAlwaysCheckedIme(Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    .end local v22    # "systemIme":Z
    :cond_c
    invoke-static {v5}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->buildInputMethodsAndSubtypesString(Ljava/util/HashMap;)Ljava/lang/String;

    move-result-object v6

    .line 255
    .local v6, "enabledIMEsAndSubtypesString":Ljava/lang/String;
    invoke-static {v3}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->buildInputMethodsString(Ljava/util/HashSet;)Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p1}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->isInputMethodSubtypeSelected(Landroid/content/ContentResolver;)Z
    ...
    invoke-static {v0, v1}, Lcom/flyme/DeviceOriginalSettings/inputmethod/InputMethodAndSubtypeUtil;->putSelectedInputMethodSubtype(Landroid/content/ContentResolver;I)V
...
.method static setSubtypesPreferenceEnabled(Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;Ljava/util/List;Ljava/lang/String;Z)V
    .locals 9
    .param p0, "context"    # Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;
...
.method private static updateSubtypesPreferenceChecked(Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;Ljava/util/List;Ljava/util/HashMap;)V
    .locals 11
    .param p0, "context"    # Lcom/flyme/DeviceOriginalSettings/SettingsPreferenceFragment;
    .annotation system Ldalvik/annotation/Signature;
        value = {
