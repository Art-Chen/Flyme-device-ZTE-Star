.class public Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity$SelectAccountListAdapter;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->TAG:Ljava/lang/String;

    .line 56
    const-string v0, "preferred_sim"

    sput-object v0, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->PREFERRED_SIM:Ljava/lang/String;

    .line 57
    const-string v0, "dialog_type"

    sput-object v0, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->DIALOG_TYPE_KEY:Ljava/lang/String;
...
.method static synthetic access$000(Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;I)Landroid/telecom/PhoneAccountHandle;
    .locals 1
    .param p0, "x0"    # Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;
    .param p1, "x1"    # I

    .prologue
    .line 53
    invoke-direct {p0, p1}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->subscriptionIdToPhoneAccountHandle(I)Landroid/telecom/PhoneAccountHandle;
...
.method static synthetic access$100(Landroid/content/Context;I)V
    ...
    .prologue
    .line 53
    invoke-static {p0, p1}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->setDefaultDataSubId(Landroid/content/Context;I)V
...
.method static synthetic access$200(Landroid/content/Context;I)V
    ...
    .prologue
    .line 53
    invoke-static {p0, p1}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->setDefaultSmsSubId(Landroid/content/Context;I)V

    return-void
.end method

.method static synthetic access$300(Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;Landroid/telecom/PhoneAccountHandle;)V
    .locals 0
    .param p0, "x0"    # Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;
    ...
    .prologue
    .line 53
    invoke-direct {p0, p1}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->setUserSelectedOutgoingPhoneAccount(Landroid/telecom/PhoneAccountHandle;)V
...
.method private displayPreferredDialog(I)V
    ...
    .prologue
    .line 86
    invoke-virtual {p0}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->getResources()Landroid/content/res/Resources;

    move-result-object v2

    .line 87
    .local v2, "res":Landroid/content/res/Resources;
    invoke-virtual {p0}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->getApplicationContext()Landroid/content/Context;

    move-result-object v1

    .line 88
    .local v1, "context":Landroid/content/Context;
    invoke-static {v1, p1}, Lcom/flyme/DeviceOriginalSettings/Utils;->findRecordBySlotId(Landroid/content/Context;I)Landroid/telephony/SubscriptionInfo;
    ...
    new-instance v5, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity$1;

    invoke-direct {v5, p0, v3, v1}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity$1;-><init>(Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;Landroid/telephony/SubscriptionInfo;Landroid/content/Context;)V
    ...
    new-instance v5, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity$2;

    invoke-direct {v5, p0}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity$2;-><init>(Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;)V
    ...
    .line 119
    :cond_0
    invoke-virtual {p0}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->finish()V
...
.method public createDialog(Landroid/content/Context;I)Landroid/app/Dialog;
    ...
    :goto_0
    new-instance v23, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity$3;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity$3;-><init>(Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;ILjava/util/List;Landroid/content/Context;)V

    .line 199
    .local v23, "selectionListener":Landroid/content/DialogInterface$OnClickListener;
    new-instance v17, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity$4;

    move-object/from16 v0, v17

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity$4;-><init>(Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->getResources()Landroid/content/res/Resources;
    ...
    invoke-static {v0, v6}, Lcom/flyme/DeviceOriginalSettings/Utils;->findRecordBySubId(Landroid/content/Context;I)Landroid/telephony/SubscriptionInfo;
    ...
    new-instance v5, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity$SelectAccountListAdapter;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity$SelectAccountListAdapter;-><init>(Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;Ljava/util/List;Landroid/content/Context;I[Ljava/lang/String;I)V
    ...
    .line 273
    new-instance v6, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity$5;

    move-object/from16 v0, p0

    invoke-direct {v6, v0}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity$5;-><init>(Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 67
    invoke-virtual {p0}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->getIntent()Landroid/content/Intent;
    ...
    sget-object v2, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->DIALOG_TYPE_KEY:Ljava/lang/String;
    ...
    .line 74
    :pswitch_0
    invoke-virtual {p0, p0, v0}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->createDialog(Landroid/content/Context;I)Landroid/app/Dialog;
    ...
    .line 77
    :pswitch_1
    sget-object v2, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->PREFERRED_SIM:Ljava/lang/String;

    invoke-virtual {v1, v2}, Landroid/os/Bundle;->getInt(Ljava/lang/String;)I

    move-result v2

    invoke-direct {p0, v2}, Lcom/flyme/DeviceOriginalSettings/sim/SimDialogActivity;->displayPreferredDialog(I)V
