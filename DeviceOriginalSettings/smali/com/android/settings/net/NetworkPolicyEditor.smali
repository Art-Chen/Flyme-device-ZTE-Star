.class public Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;
...
.method public constructor <init>(Landroid/net/NetworkPolicyManager;)V
    ...
    iput-object v0, p0, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->mPolicyManager:Landroid/net/NetworkPolicyManager;
...
.method public getOrCreatePolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .prologue
    .line 100
    invoke-virtual {p0, p1}, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .line 102
    invoke-static {p1}, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->buildDefaultPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;

    move-result-object v0

    .line 103
    iget-object v1, p0, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
...
.method public getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .prologue
    .line 109
    iget-object v2, p0, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
...
.method public getPolicyMaybeUnquoted(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    :cond_0
    invoke-static {p1}, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->buildUnquotedNetworkTemplate(Landroid/net/NetworkTemplate;)Landroid/net/NetworkTemplate;

    move-result-object v1

    invoke-virtual {p0, v1}, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public read()V
    ...
    .line 56
    iget-object v6, p0, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->mPolicyManager:Landroid/net/NetworkPolicyManager;
    ...
    .line 59
    .local v3, "modified":Z
    iget-object v6, p0, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0}, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->writeAsync()V
...
.method public setPolicyCycleDay(Landroid/net/NetworkTemplate;ILjava/lang/String;)V
    ...
    .prologue
    .line 155
    invoke-virtual {p0, p1}, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->getOrCreatePolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public setPolicyMetered(Landroid/net/NetworkTemplate;Z)V
    ...
    .line 207
    iget-object v4, p0, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v2}, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public write([Landroid/net/NetworkPolicy;)V
    ...
    .prologue
    .line 91
    iget-object v0, p0, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;->mPolicyManager:Landroid/net/NetworkPolicyManager;
...
.method public writeAsync()V
    ...
    new-instance v1, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor$1;

    invoke-direct {v1, p0, v0}, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor$1;-><init>(Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor;[Landroid/net/NetworkPolicy;)V

    const/4 v2, 0x0

    new-array v2, v2, [Ljava/lang/Void;

    invoke-virtual {v1, v2}, Lcom/flyme/DeviceOriginalSettings/net/NetworkPolicyEditor$1;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
