.class public Lcom/flyme/DeviceOriginalSettings/net/UidDetailProvider;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/flyme/DeviceOriginalSettings/net/UidDetailProvider;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/flyme/DeviceOriginalSettings/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
...
.method private buildUidDetail(I)Lcom/flyme/DeviceOriginalSettings/net/UidDetail;
    .locals 22
    .param p1, "uid"    # I
    ...
    iget-object v0, v0, Lcom/flyme/DeviceOriginalSettings/net/UidDetailProvider;->mContext:Landroid/content/Context;
    ...
    new-instance v5, Lcom/flyme/DeviceOriginalSettings/net/UidDetail;

    invoke-direct {v5}, Lcom/flyme/DeviceOriginalSettings/net/UidDetail;-><init>()V

    .line 109
    .local v5, "detail":Lcom/flyme/DeviceOriginalSettings/net/UidDetail;
    move/from16 v0, p1
    ...
    iput-object v0, v5, Lcom/flyme/DeviceOriginalSettings/net/UidDetail;->label:Ljava/lang/CharSequence;
    ...
    iput-object v0, v5, Lcom/flyme/DeviceOriginalSettings/net/UidDetail;->icon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static/range {p1 .. p1}, Lcom/flyme/DeviceOriginalSettings/net/UidDetailProvider;->isKeyForUser(I)Z
    ...
    .line 136
    invoke-static/range {p1 .. p1}, Lcom/flyme/DeviceOriginalSettings/net/UidDetailProvider;->getUserIdForKey(I)I
    ...
    invoke-static {v0, v8}, Lcom/flyme/DeviceOriginalSettings/Utils;->getUserLabel(Landroid/content/Context;Landroid/content/pm/UserInfo;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v8}, Lcom/flyme/DeviceOriginalSettings/Utils;->getUserIcon(Landroid/content/Context;Landroid/os/UserManager;Landroid/content/pm/UserInfo;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    iget-object v0, v5, Lcom/flyme/DeviceOriginalSettings/net/UidDetail;->label:Ljava/lang/CharSequence;
    ...
    iput-object v0, v5, Lcom/flyme/DeviceOriginalSettings/net/UidDetail;->contentDescription:Ljava/lang/CharSequence;
    :try_end_0
    ...
    iput-object v0, v5, Lcom/flyme/DeviceOriginalSettings/net/UidDetail;->detailLabels:[Ljava/lang/CharSequence;
    ...
    iput-object v0, v5, Lcom/flyme/DeviceOriginalSettings/net/UidDetail;->detailContentDescriptions:[Ljava/lang/CharSequence;
    ...
    .line 170
    iget-object v0, v5, Lcom/flyme/DeviceOriginalSettings/net/UidDetail;->detailLabels:[Ljava/lang/CharSequence;
    ...
    .line 171
    iget-object v0, v5, Lcom/flyme/DeviceOriginalSettings/net/UidDetail;->detailContentDescriptions:[Ljava/lang/CharSequence;
...
.method public clearCache()V
    ...
    .prologue
    .line 70
    iget-object v1, p0, Lcom/flyme/DeviceOriginalSettings/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;

    monitor-enter v1

    .line 71
    :try_start_0
    iget-object v0, p0, Lcom/flyme/DeviceOriginalSettings/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
...
.method public getUidDetail(IZ)Lcom/flyme/DeviceOriginalSettings/net/UidDetail;
    .locals 3
    .param p1, "uid"    # I
    .param p2, "blocking"    # Z
    ...
    .prologue
    .line 81
    iget-object v2, p0, Lcom/flyme/DeviceOriginalSettings/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
    ...
    check-cast v0, Lcom/flyme/DeviceOriginalSettings/net/UidDetail;

    .line 83
    .local v0, "detail":Lcom/flyme/DeviceOriginalSettings/net/UidDetail;
    monitor-exit v2
    ...
    .line 83
    .end local v0    # "detail":Lcom/flyme/DeviceOriginalSettings/net/UidDetail;
    :catchall_0
    move-exception v1
    ...
    .line 87
    .restart local v0    # "detail":Lcom/flyme/DeviceOriginalSettings/net/UidDetail;
    :cond_0
    if-nez p2, :cond_1
    ...
    .line 91
    :cond_1
    invoke-direct {p0, p1}, Lcom/flyme/DeviceOriginalSettings/net/UidDetailProvider;->buildUidDetail(I)Lcom/flyme/DeviceOriginalSettings/net/UidDetail;
