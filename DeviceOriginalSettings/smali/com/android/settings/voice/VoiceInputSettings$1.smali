.class final Lcom/flyme/DeviceOriginalSettings/voice/VoiceInputSettings$1;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/flyme/DeviceOriginalSettings/voice/VoiceInputSettings;
.end annotation
...
.method private getSearchIndexableRaw(Landroid/content/Context;Landroid/content/pm/ResolveInfo;Ljava/lang/String;)Lcom/flyme/DeviceOriginalSettings/search/SearchIndexableRaw;
    .locals 5
    ...
    .line 235
    .local v1, "indexable":Lcom/flyme/DeviceOriginalSettings/search/SearchIndexableRaw;
    invoke-virtual {v0}, Landroid/content/ComponentName;->flattenToString()Ljava/lang/String;

    move-result-object v3

    iput-object v3, v1, Lcom/flyme/DeviceOriginalSettings/search/SearchIndexableRaw;->key:Ljava/lang/String;
    ...
    iput-object v3, v1, Lcom/flyme/DeviceOriginalSettings/search/SearchIndexableRaw;->title:Ljava/lang/String;

    .line 237
    iput-object p3, v1, Lcom/flyme/DeviceOriginalSettings/search/SearchIndexableRaw;->screenTitle:Ljava/lang/String;
...
.method public getRawDataToIndex(Landroid/content/Context;Z)Ljava/util/List;
    ...
    .line 189
    .local v4, "indexables":Ljava/util/List;, "Ljava/util/List<Lcom/flyme/DeviceOriginalSettings/search/SearchIndexableRaw;>;"
    const v10, 0x7f0909aa
    ...
    new-instance v3, Lcom/flyme/DeviceOriginalSettings/search/SearchIndexableRaw;

    invoke-direct {v3, p1}, Lcom/flyme/DeviceOriginalSettings/search/SearchIndexableRaw;-><init>(Landroid/content/Context;)V

    .line 192
    .local v3, "indexable":Lcom/flyme/DeviceOriginalSettings/search/SearchIndexableRaw;
    const-string v10, "voice_service_preference_section_title"

    iput-object v10, v3, Lcom/flyme/DeviceOriginalSettings/search/SearchIndexableRaw;->key:Ljava/lang/String;

    .line 193
    const v10, 0x7f0909ab

    invoke-virtual {p1, v10}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v10

    iput-object v10, v3, Lcom/flyme/DeviceOriginalSettings/search/SearchIndexableRaw;->title:Ljava/lang/String;

    .line 194
    iput-object v7, v3, Lcom/flyme/DeviceOriginalSettings/search/SearchIndexableRaw;->screenTitle:Ljava/lang/String;
    ...
    .line 210
    :cond_0
    invoke-direct {p0, p1, v5, v7}, Lcom/flyme/DeviceOriginalSettings/voice/VoiceInputSettings$1;->getSearchIndexableRaw(Landroid/content/Context;Landroid/content/pm/ResolveInfo;Ljava/lang/String;)Lcom/flyme/DeviceOriginalSettings/search/SearchIndexableRaw;
