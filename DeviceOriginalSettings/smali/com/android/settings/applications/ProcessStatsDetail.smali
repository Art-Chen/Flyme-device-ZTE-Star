...
.method private fillServicesSection()V
    ...
    iget-object v9, v9, Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry;->mServices:Landroid/util/ArrayMap;
    ...
    .line 240
    .local v6, "servicePkgs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/util/ArrayList<Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry$Service;>;>;"
    const/4 v1, 0x0
    ...
    .line 243
    .local v7, "services":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry$Service;>;"
    sget-object v9, Lcom/flyme/DeviceOriginalSettings/applications/ProcessStatsDetail;->sServiceCompare:Ljava/util/Comparator;
    ...
    .line 246
    .end local v7    # "services":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry$Service;>;"
    :cond_0
    iget-object v9, p0, Lcom/flyme/DeviceOriginalSettings/applications/ProcessStatsDetail;->mEntry:Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry;
    ...
    check-cast v9, Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry$Service;

    iget-object v9, v9, Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry$Service;->mPackage:Ljava/lang/String;

    iget-object v10, p0, Lcom/flyme/DeviceOriginalSettings/applications/ProcessStatsDetail;->mEntry:Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry;

    iget-object v10, v10, Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry;->mPackage:Ljava/lang/String;
    ...
    .line 250
    sget-object v9, Lcom/flyme/DeviceOriginalSettings/applications/ProcessStatsDetail;->sServicePkgCompare:Ljava/util/Comparator;
    ...
    .line 254
    .restart local v7    # "services":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry$Service;>;"
    if-eqz v0, :cond_3

    .line 255
    iget-object v10, p0, Lcom/flyme/DeviceOriginalSettings/applications/ProcessStatsDetail;->mServicesParent:Landroid/view/ViewGroup;
    ...
    invoke-direct {p0, v10, v9}, Lcom/flyme/DeviceOriginalSettings/applications/ProcessStatsDetail;->addPackageHeaderItem(Landroid/view/ViewGroup;Ljava/lang/String;)V
    ...
    check-cast v5, Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry$Service;

    .line 259
    .local v5, "service":Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry$Service;
    iget-object v3, v5, Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry$Service;->mName:Ljava/lang/String;
    ...
    .line 264
    :cond_4
    iget-wide v10, v5, Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry$Service;->mDuration:J

    iget-wide v12, p0, Lcom/flyme/DeviceOriginalSettings/applications/ProcessStatsDetail;->mTotalTime:J

    invoke-static {v10, v11, v12, v13}, Lcom/flyme/DeviceOriginalSettings/Utils;->formatPercentage(JJ)Ljava/lang/String;

    move-result-object v4

    .line 265
    .local v4, "percentage":Ljava/lang/String;
    iget-object v9, p0, Lcom/flyme/DeviceOriginalSettings/applications/ProcessStatsDetail;->mServicesParent:Landroid/view/ViewGroup;

    invoke-direct {p0, v9, v3, v4}, Lcom/flyme/DeviceOriginalSettings/applications/ProcessStatsDetail;->addDetailsItem(Landroid/view/ViewGroup;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    .end local v5    # "service":Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry$Service;
    .end local v8    # "tail":I
    :cond_5
    add-int/lit8 v1, v1, 0x1
    ...
    .end local v1    # "ip":I
    .end local v2    # "is":I
    .end local v6    # "servicePkgs":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/util/ArrayList<Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry$Service;>;>;"
    .end local v7    # "services":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/flyme/DeviceOriginalSettings/applications/ProcStatsEntry$Service;>;"
    :cond_6
    return-void
.end method
