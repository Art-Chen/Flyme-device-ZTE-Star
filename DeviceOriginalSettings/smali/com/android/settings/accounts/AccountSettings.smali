...
.method private getAccountTypePreferences(Lcom/flyme/DeviceOriginalSettings/accounts/AuthenticatorHelper;Landroid/os/UserHandle;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 358
    invoke-virtual/range {p1 .. p1}, Lcom/flyme/DeviceOriginalSettings/accounts/AuthenticatorHelper;->getEnabledAccountTypes()[Ljava/lang/String;
    ...
    .line 362
    .local v12, "accountTypePreferences":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/flyme/DeviceOriginalSettings/accounts/AccountSettings$AccountPreference;>;"
    const/4 v15, 0x0
    ...
    invoke-direct {v0, v1, v11}, Lcom/flyme/DeviceOriginalSettings/accounts/AccountSettings;->accountTypeHasAnyRequestedAuthorities(Lcom/flyme/DeviceOriginalSettings/accounts/AuthenticatorHelper;Ljava/lang/String;)Z
    ...
    .line 368
    :cond_1
    invoke-virtual/range {p0 .. p0}, Lcom/flyme/DeviceOriginalSettings/accounts/AccountSettings;->getActivity()Landroid/app/Activity;

    move-result-object v2

    move-object/from16 v0, p1

    invoke-virtual {v0, v2, v11}, Lcom/flyme/DeviceOriginalSettings/accounts/AuthenticatorHelper;->getLabelForType(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v11}, Lcom/flyme/DeviceOriginalSettings/accounts/AuthenticatorHelper;->getPackageForType(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v11}, Lcom/flyme/DeviceOriginalSettings/accounts/AuthenticatorHelper;->getLabelIdForType(Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v11}, Lcom/flyme/DeviceOriginalSettings/accounts/AuthenticatorHelper;->hasAccountPreferences(Ljava/lang/String;)Z
    ...
    .line 386
    new-instance v2, Lcom/flyme/DeviceOriginalSettings/accounts/AccountSettings$AccountPreference;

    invoke-virtual/range {p0 .. p0}, Lcom/flyme/DeviceOriginalSettings/accounts/AccountSettings;->getActivity()Landroid/app/Activity;

    move-result-object v4

    const-class v3, Lcom/flyme/DeviceOriginalSettings/accounts/AccountSyncSettings;
    ...
    invoke-virtual {v0, v3, v11}, Lcom/flyme/DeviceOriginalSettings/accounts/AuthenticatorHelper;->getDrawableForType(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;

    move-result-object v10

    move-object/from16 v3, p0

    invoke-direct/range {v2 .. v10}, Lcom/flyme/DeviceOriginalSettings/accounts/AccountSettings$AccountPreference;-><init>(Lcom/flyme/DeviceOriginalSettings/accounts/AccountSettings;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/String;ILjava/lang/String;Landroid/os/Bundle;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v2, v11}, Lcom/flyme/DeviceOriginalSettings/accounts/AuthenticatorHelper;->preloadDrawableForType(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-class v3, Lcom/flyme/DeviceOriginalSettings/accounts/ManageAccountsSettings;
    ...
    .end local v16    # "skipToAccount":Z
    :cond_4
    new-instance v2, Lcom/flyme/DeviceOriginalSettings/accounts/AccountSettings$2;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Lcom/flyme/DeviceOriginalSettings/accounts/AccountSettings$2;-><init>(Lcom/flyme/DeviceOriginalSettings/accounts/AccountSettings;)V
