...
.field private final mCmHardwareManager:Landroid/hardware/CmHardwareManager;
...
.field private final mObserver:Lcom/android/server/display/LiveDisplayController$SettingsObserver;
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;)V
    ...
    iput v2, p0, Lcom/android/server/display/LiveDisplayController;->mColorTemperature:I

    .line 67
    const/4 v2, 0x0

    iput v2, p0, Lcom/android/server/display/LiveDisplayController;->mCurrentLux:F
    ...
    iput-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mColorAdjustment:[F
    ...
    iput-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mRGB:[F

    .line 91
    iput-boolean v3, p0, Lcom/android/server/display/LiveDisplayController;->mSunset:Z

    .line 93
    new-instance v2, Lcom/android/server/display/LiveDisplayController$SettingsObserver;

    invoke-direct {v2, p0}, Lcom/android/server/display/LiveDisplayController$SettingsObserver;-><init>(Lcom/android/server/display/LiveDisplayController;)V

    iput-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mObserver:Lcom/android/server/display/LiveDisplayController$SettingsObserver;

    .line 104
    iput-boolean v3, p0, Lcom/android/server/display/LiveDisplayController;->mLowPerformance:Z

    .line 105
    new-instance v2, Lcom/android/server/display/LiveDisplayController$1;

    invoke-direct {v2, p0}, Lcom/android/server/display/LiveDisplayController$1;-><init>(Lcom/android/server/display/LiveDisplayController;)V

    iput-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mLowPowerModeListener:Landroid/os/PowerManagerInternal$LowPowerModeListener;
    ...
    iput-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mTwilightListener:Lcom/android/server/twilight/TwilightListener;

    .line 115
    iput-object p1, p0, Lcom/android/server/display/LiveDisplayController;->mContext:Landroid/content/Context;

    .line 116
    new-instance v2, Lcom/android/server/display/LiveDisplayController$LiveDisplayHandler;

    invoke-direct {v2, p0, p2}, Lcom/android/server/display/LiveDisplayController$LiveDisplayHandler;-><init>(Lcom/android/server/display/LiveDisplayController;Landroid/os/Looper;)V

    iput-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mHandler:Landroid/os/Handler;
    ...
    check-cast v2, Landroid/hardware/CmHardwareManager;

    iput-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;
    ...
    iput-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mTwilightManager:Lcom/android/server/twilight/TwilightManager;

    .line 120
    iget-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mTwilightManager:Lcom/android/server/twilight/TwilightManager;

    iget-object v3, p0, Lcom/android/server/display/LiveDisplayController;->mTwilightListener:Lcom/android/server/twilight/TwilightListener;

    iget-object v4, p0, Lcom/android/server/display/LiveDisplayController;->mHandler:Landroid/os/Handler;
    ...
    .line 122
    iget-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;

    const/16 v3, 0x100

    invoke-virtual {v2, v3}, Landroid/hardware/CmHardwareManager;->isSupported(I)Z

    move-result v1

    .line 125
    .local v1, "sunlightEnhancementSupported":Z
    if-eqz v1, :cond_0
    ...
    invoke-virtual {v2, v3}, Landroid/hardware/CmHardwareManager;->get(I)Z

    move-result v2

    iput-boolean v2, p0, Lcom/android/server/display/LiveDisplayController;->mOutdoorMode:Z

    .line 129
    :cond_0
    iget-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;

    invoke-virtual {v2, v7}, Landroid/hardware/CmHardwareManager;->isSupported(I)Z
    ...
    invoke-virtual {v2, v7}, Landroid/hardware/CmHardwareManager;->get(I)Z

    move-result v2

    iput-boolean v2, p0, Lcom/android/server/display/LiveDisplayController;->mColorEnhancement:Z

    .line 134
    :cond_1
    iget-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;

    invoke-virtual {v2, v5}, Landroid/hardware/CmHardwareManager;->isSupported(I)Z
    ...
    invoke-virtual {v2, v5}, Landroid/hardware/CmHardwareManager;->get(I)Z

    move-result v2

    iput-boolean v2, p0, Lcom/android/server/display/LiveDisplayController;->mLowPower:Z
    ...
    iput v2, p0, Lcom/android/server/display/LiveDisplayController;->mDefaultDayTemperature:I
    ...
    iput v2, p0, Lcom/android/server/display/LiveDisplayController;->mDefaultNightTemperature:I
    ...
    iput v2, p0, Lcom/android/server/display/LiveDisplayController;->mDefaultOutdoorLux:I
    ...
    const-string v3, "live_display_hinted"
    ...
    iput v2, p0, Lcom/android/server/display/LiveDisplayController;->mHintCounter:I
    ...
    .line 159
    iget-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mObserver:Lcom/android/server/display/LiveDisplayController$SettingsObserver;

    invoke-virtual {v2, v5}, Lcom/android/server/display/LiveDisplayController$SettingsObserver;->register(Z)V
    ...
    iget-object v2, p0, Lcom/android/server/display/LiveDisplayController;->mLowPowerModeListener:Landroid/os/PowerManagerInternal$LowPowerModeListener;
    ...
    iput-boolean v2, p0, Lcom/android/server/display/LiveDisplayController;->mLowPerformance:Z
...
.method static synthetic access$1000(Lcom/android/server/display/LiveDisplayController;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/LiveDisplayController;
...
.method static synthetic access$1100(Lcom/android/server/display/LiveDisplayController;Lcom/android/server/twilight/TwilightState;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/LiveDisplayController;
...
.method static synthetic access$1200(Lcom/android/server/display/LiveDisplayController;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/LiveDisplayController;
...
.method static synthetic access$600(Lcom/android/server/display/LiveDisplayController;)Lcom/android/server/twilight/TwilightManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/LiveDisplayController;
...
.method static synthetic access$700(Lcom/android/server/display/LiveDisplayController;Lcom/android/server/twilight/TwilightState;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/LiveDisplayController;
    .param p1, "x1"    # Lcom/android/server/twilight/TwilightState;
...
.method private declared-synchronized setDisplayTemperature(I)V
    ...
    .line 328
    iget-object v4, p0, Lcom/android/server/display/LiveDisplayController;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;

    const/4 v5, 0x4

    invoke-virtual {v4, v5}, Landroid/hardware/CmHardwareManager;->isSupported(I)Z
    ...
    invoke-virtual {v4}, Landroid/hardware/CmHardwareManager;->getDisplayColorCalibrationMax()I
    ...
    invoke-virtual {v4, v5}, Landroid/hardware/CmHardwareManager;->setDisplayColorCalibration([I)Z
...
.method private declared-synchronized updateColorEnhancement(Lcom/android/server/twilight/TwilightState;)V
    ...
    :cond_0
    :goto_0
    iget-boolean v1, p0, Lcom/android/server/display/LiveDisplayController;->mColorEnhancement:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_2
    :try_start_1
    iget-object v1, p0, Lcom/android/server/display/LiveDisplayController;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;

    const/4 v2, 0x2

    invoke-virtual {v1, v2, v0}, Landroid/hardware/CmHardwareManager;->set(IZ)Z
...
.method private declared-synchronized updateLowPowerMode()V
    ...
    iget v1, p0, Lcom/android/server/display/LiveDisplayController;->mCurrentLux:F

    iget v2, p0, Lcom/android/server/display/LiveDisplayController;->mDefaultOutdoorLux:I
    ...
    .local v0, "enabled":Z
    :goto_0
    iget-boolean v1, p0, Lcom/android/server/display/LiveDisplayController;->mLowPower:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private declared-synchronized updateOutdoorMode(Lcom/android/server/twilight/TwilightState;)V
    ...
    .local v0, "enabled":Z
    :goto_0
    iget-boolean v1, p0, Lcom/android/server/display/LiveDisplayController;->mOutdoorMode:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private updateSettings()V
    ...
    iget v7, p0, Lcom/android/server/display/LiveDisplayController;->mDefaultDayTemperature:I
    ...
    iget v7, p0, Lcom/android/server/display/LiveDisplayController;->mDefaultNightTemperature:I
    ...
    invoke-static {v3, v6, v5, v8}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    .line 179
    iget-object v3, p0, Lcom/android/server/display/LiveDisplayController;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;

    const/16 v6, 0x100

    invoke-virtual {v3, v6}, Landroid/hardware/CmHardwareManager;->isSupported(I)Z
    ...
    .line 180
    iput-boolean v5, p0, Lcom/android/server/display/LiveDisplayController;->mUseOutdoorMode:Z

    .line 187
    :goto_0
    iget-object v3, p0, Lcom/android/server/display/LiveDisplayController;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;

    invoke-virtual {v3, v4}, Landroid/hardware/CmHardwareManager;->isSupported(I)Z
    ...
    .line 188
    iput-boolean v5, p0, Lcom/android/server/display/LiveDisplayController;->mUseLowPower:Z

    .line 195
    :goto_1
    iget-object v3, p0, Lcom/android/server/display/LiveDisplayController;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;

    invoke-virtual {v3, v9}, Landroid/hardware/CmHardwareManager;->isSupported(I)Z
    ...
    .line 196
    iput-boolean v5, p0, Lcom/android/server/display/LiveDisplayController;->mColorEnhancement:Z
    ...
    .line 206
    invoke-direct {p0, v4}, Lcom/android/server/display/LiveDisplayController;->saveUserHint(I)V
    ...
    const-string v6, "display_color_adjustment"

    invoke-static {v3, v6, v8}, Landroid/provider/Settings$System;->getStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 182
    .end local v0    # "colorAdjustment":[Ljava/lang/String;
    .end local v1    # "colorAdjustmentTemp":Ljava/lang/String;
    :cond_3
    iget-object v3, p0, Lcom/android/server/display/LiveDisplayController;->mContext:Landroid/content/Context;
    ...
    invoke-static {v3, v6, v4, v8}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    :goto_5
    iput-boolean v3, p0, Lcom/android/server/display/LiveDisplayController;->mUseOutdoorMode:Z
    ...
    const-string v6, "display_low_power"
    ...
    :goto_6
    iput-boolean v3, p0, Lcom/android/server/display/LiveDisplayController;->mUseLowPower:Z
    ...
    const-string v6, "display_color_enhance"
    ...
    :goto_7
    iput-boolean v3, p0, Lcom/android/server/display/LiveDisplayController;->mColorEnhancement:Z
    ...
    .line 213
    .restart local v1    # "colorAdjustmentTemp":Ljava/lang/String;
    :cond_9
    const-string v3, " "
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    .line 593
    .local v2, "hasSunlightEnhancement":Z
    iget-object v3, p0, Lcom/android/server/display/LiveDisplayController;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;
    ...
    .line 595
    .local v1, "hasColorEnhancement":Z
    iget-object v3, p0, Lcom/android/server/display/LiveDisplayController;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;

    invoke-virtual {v3, v5}, Landroid/hardware/CmHardwareManager;->isSupported(I)Z

    move-result v0

    .line 598
    .local v0, "hasAdaptiveBacklight":Z
    invoke-virtual {p1}, Ljava/io/PrintWriter;->println()V

    .line 599
    const-string v3, "LiveDisplay Controller Configuration:"
    ...
    const-string v4, "  mDayTemperature="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lcom/android/server/display/LiveDisplayController;->mDayTemperature:I
    ...
    const-string v4, "  mNightTemperature="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lcom/android/server/display/LiveDisplayController;->mNightTemperature:I
    ...
    const-string v4, "  mUseOutdoorMode="
    ...
    const-string v4, "  mUseColorEnhancement="
    ...
    .line 609
    const-string v3, "LiveDisplay Controller State:"
    ...
    const-string v3, "disabled in powersave mode"
    ...
    const-string v4, "  mSunset="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-boolean v4, p0, Lcom/android/server/display/LiveDisplayController;->mSunset:Z
    ...
    iget v4, p0, Lcom/android/server/display/LiveDisplayController;->mColorTemperature:I
    ...
    const-string v4, "  mColorAdjustment=[r: "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Lcom/android/server/display/LiveDisplayController;->mColorAdjustment:[F
    ...
    const-string v4, "  mOutdoorMode="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-boolean v4, p0, Lcom/android/server/display/LiveDisplayController;->mOutdoorMode:Z
    ...
    const-string v4, "  mColorEnhancement="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-boolean v4, p0, Lcom/android/server/display/LiveDisplayController;->mColorEnhancement:Z
    ...
    const-string v4, "  mLowPower="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-boolean v4, p0, Lcom/android/server/display/LiveDisplayController;->mLowPower:Z
