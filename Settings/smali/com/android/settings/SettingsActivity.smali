...
.field private mNfcProfileCallback:Lcom/android/settings/profiles/NFCProfileTagCallback;
...
.method static constructor <clinit>()V
    ...
    const-class v2, Lcom/android/settings/notification/NotificationManagerSettings;
    ...
    const-class v2, Lcom/android/settings/lockscreen/LockScreenSettings;
    ...
    const-class v2, Lcom/android/settings/livedisplay/LiveDisplay;
...
.method private loadCategoriesFromResource(ILjava/util/List;)V
    ...
    invoke-static/range {p0 .. p0}, Lcom/android/settings/SettingsActivity;->showAdvancedPreferences(Landroid/content/Context;)Z
    ...
    .line 1038
    new-instance v5, Lcom/android/settings/dashboard/DashboardCategory;

    invoke-direct {v5}, Lcom/android/settings/dashboard/DashboardCategory;-><init>()V
    ...
    invoke-virtual {v0, v4, v1}, Lcom/android/settings/SettingsActivity;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    iput-wide v0, v5, Lcom/android/settings/dashboard/DashboardCategory;->id:J
    ...
    iput v0, v5, Lcom/android/settings/dashboard/DashboardCategory;->titleRes:I
    ...
    .line 1066
    new-instance v18, Lcom/android/settings/dashboard/DashboardTile;

    invoke-direct/range {v18 .. v18}, Lcom/android/settings/dashboard/DashboardTile;-><init>()V

    .line 1068
    .local v18, "tile":Lcom/android/settings/dashboard/DashboardTile;
    sget-object v22, Lcom/android/settings/R$styleable;->Preference:[I
    ...
    .line 1109
    sget-object v22, Lcom/android/settings/R$styleable;->DashboardTile:[I
    ...
    iput-object v0, v1, Lcom/android/settings/dashboard/DashboardTile;->switchControl:Ljava/lang/String;
    ...
    .end local v18    # "tile":Lcom/android/settings/dashboard/DashboardTile;
    ...
    iput-object v0, v5, Lcom/android/settings/dashboard/DashboardCategory;->title:Ljava/lang/CharSequence;
    ...
    .restart local v18    # "tile":Lcom/android/settings/dashboard/DashboardTile;
    :cond_12
    const/16 v21, 0x0
    ...
    iput-object v6, v0, Lcom/android/settings/dashboard/DashboardTile;->fragmentArguments:Landroid/os/Bundle;
    ...
    invoke-virtual {v5, v0}, Lcom/android/settings/dashboard/DashboardCategory;->addTile(Lcom/android/settings/dashboard/DashboardTile;)V
...
.method private updateTilesList(Ljava/util/List;)V
    ...
    iget-wide v0, v2, Lcom/android/settings/dashboard/DashboardCategory;->id:J
    ...
    .line 1186
    invoke-virtual {v2, v8}, Lcom/android/settings/dashboard/DashboardCategory;->getTile(I)Lcom/android/settings/dashboard/DashboardTile;
    ...
    .line 1272
    invoke-virtual {v2, v8}, Lcom/android/settings/dashboard/DashboardCategory;->removeTile(I)V
...
.method protected onNewIntent(Landroid/content/Intent;)V
    ...
    iget-object v1, p0, Lcom/android/settings/SettingsActivity;->mNfcProfileCallback:Lcom/android/settings/profiles/NFCProfileTagCallback;
    ...
    invoke-interface {v1, v0}, Lcom/android/settings/profiles/NFCProfileTagCallback;->onTagRead(Landroid/nfc/Tag;)V
...
.method public setNfcProfileCallback(Lcom/android/settings/profiles/NFCProfileTagCallback;)V
    .locals 0
    .param p1, "callback"    # Lcom/android/settings/profiles/NFCProfileTagCallback;

    .prologue
    .line 1425
    iput-object p1, p0, Lcom/android/settings/SettingsActivity;->mNfcProfileCallback:Lcom/android/settings/profiles/NFCProfileTagCallback;
