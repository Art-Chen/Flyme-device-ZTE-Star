...
.method private updateInternal()V
    ...
    .line 522
    iget-object v9, p0, Lcom/android/settings/search/Index;->mDataToProcess:Lcom/android/settings/search/Index$UpdateData;

    monitor-enter v9

    .line 523
    :try_start_0
    new-instance v7, Lcom/android/settings/search/Index$UpdateIndexTask;

    const/4 v10, 0x0

    invoke-direct {v7, p0, v10}, Lcom/android/settings/search/Index$UpdateIndexTask;-><init>(Lcom/android/settings/search/Index;Lcom/android/settings/search/Index$1;)V

    .line 524
    .local v7, "task":Lcom/android/settings/search/Index$UpdateIndexTask;
    iget-object v10, p0, Lcom/android/settings/search/Index;->mDataToProcess:Lcom/android/settings/search/Index$UpdateData;

    invoke-virtual {v10}, Lcom/android/settings/search/Index$UpdateData;->copy()Lcom/android/settings/search/Index$UpdateData;

    move-result-object v2

    .line 525
    .local v2, "copy":Lcom/android/settings/search/Index$UpdateData;
    iget-object v10, v2, Lcom/android/settings/search/Index$UpdateData;->dataToUpdate:Ljava/util/List;
    ...
    invoke-static {v10}, Lcom/android/settings/search/Index;->getIndexableClass(Ljava/lang/String;)Ljava/lang/Class;
    ...
    invoke-direct {p0, v1}, Lcom/android/settings/search/Index;->getSearchIndexProvider(Ljava/lang/Class;)Lcom/android/settings/search/Indexable$SearchIndexProvider;
    ...
    .line 533
    invoke-interface {v5}, Lcom/android/settings/search/Indexable$SearchIndexProvider;->prepare()V

    goto :goto_0

    .line 539
    .end local v1    # "clazz":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .end local v2    # "copy":Lcom/android/settings/search/Index$UpdateData;
    ...
    .end local v7    # "task":Lcom/android/settings/search/Index$UpdateIndexTask;
    :catchall_0
    move-exception v8
    ...
    .restart local v2    # "copy":Lcom/android/settings/search/Index$UpdateData;
    ...
    .restart local v7    # "task":Lcom/android/settings/search/Index$UpdateIndexTask;
    :cond_1
    move-object v1, v8
    ...
    :try_start_1
    new-array v8, v8, [Lcom/android/settings/search/Index$UpdateData;

    const/4 v10, 0x0

    aput-object v2, v8, v10

    invoke-virtual {v7, v8}, Lcom/android/settings/search/Index$UpdateIndexTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;

    .line 538
    iget-object v8, p0, Lcom/android/settings/search/Index;->mDataToProcess:Lcom/android/settings/search/Index$UpdateData;

    invoke-virtual {v8}, Lcom/android/settings/search/Index$UpdateData;->clear()V
