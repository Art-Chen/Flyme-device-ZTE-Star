...
# direct methods
.method constructor <init>(Lcom/android/settings/cyanogenmod/SpamList;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/android/settings/cyanogenmod/SpamList$SpamAdapter;->this$0:Lcom/android/settings/cyanogenmod/SpamList;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 283
    .local v0, "info":Lcom/android/settings/cyanogenmod/SpamList$ItemInfo;
    if-nez v3, :cond_1
    ...
    iget-object v4, p0, Lcom/android/settings/cyanogenmod/SpamList$SpamAdapter;->this$0:Lcom/android/settings/cyanogenmod/SpamList;

    invoke-virtual {v4}, Lcom/android/settings/cyanogenmod/SpamList;->getActivity()Landroid/app/Activity;
    ...
    .line 289
    check-cast v0, Lcom/android/settings/cyanogenmod/SpamList$PackageInfo;

    .end local v0    # "info":Lcom/android/settings/cyanogenmod/SpamList$ItemInfo;
    iget-object v1, v0, Lcom/android/settings/cyanogenmod/SpamList$PackageInfo;->applicationLabel:Ljava/lang/CharSequence;
    ...
    .restart local v0    # "info":Lcom/android/settings/cyanogenmod/SpamList$ItemInfo;
    :cond_1
    if-nez p2, :cond_2
    ...
    .end local v0    # "info":Lcom/android/settings/cyanogenmod/SpamList$ItemInfo;
    iget-object v1, v0, Lcom/android/settings/cyanogenmod/SpamList$NotificationInfo;->messageText:Ljava/lang/String;
...
.method public removeItem(I)V
    ...
    .line 260
    iget-object v2, p0, Lcom/android/settings/cyanogenmod/SpamList$SpamAdapter;->mItems:Ljava/util/List;
    ...
    .line 261
    .local v0, "item":Lcom/android/settings/cyanogenmod/SpamList$ItemInfo;
    # getter for: Lcom/android/settings/cyanogenmod/SpamList;->PACKAGES_NOTIFICATION_URI:Landroid/net/Uri;
    ...
    .end local v0    # "item":Lcom/android/settings/cyanogenmod/SpamList$ItemInfo;
    ...
    iget-object v2, p0, Lcom/android/settings/cyanogenmod/SpamList$SpamAdapter;->this$0:Lcom/android/settings/cyanogenmod/SpamList;
