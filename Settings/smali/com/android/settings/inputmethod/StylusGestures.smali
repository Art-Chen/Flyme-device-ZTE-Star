...
.method private addApplicationEntries(Landroid/preference/ListPreference;Ljava/lang/String;)V
    ...
    .prologue
    .line 150
    invoke-virtual {p0}, Lcom/android/settings/inputmethod/StylusGestures;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    iget-object v10, p0, Lcom/android/settings/inputmethod/StylusGestures;->mActionValues:[Ljava/lang/String;
    ...
    .local v2, "i":I
    :goto_0
    iget-object v9, p0, Lcom/android/settings/inputmethod/StylusGestures;->mActionValues:[Ljava/lang/String;
    ...
    .line 165
    iget-object v9, p0, Lcom/android/settings/inputmethod/StylusGestures;->mActionNames:[Ljava/lang/String;
    ...
    .line 183
    invoke-direct {p0, p1, p2}, Lcom/android/settings/inputmethod/StylusGestures;->setPrefValue(Landroid/preference/ListPreference;Ljava/lang/String;)V
...
.method private getAppName(Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    .prologue
    .line 187
    iget-object v3, p0, Lcom/android/settings/inputmethod/StylusGestures;->mContext:Landroid/content/Context;
...
.method private mapUpdateValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    .local v0, "i":I
    :goto_0
    iget-object v1, p0, Lcom/android/settings/inputmethod/StylusGestures;->mActionValues:[Ljava/lang/String;
    ...
    .line 121
    iget-object v1, p0, Lcom/android/settings/inputmethod/StylusGestures;->mActionNames:[Ljava/lang/String;
...
.method private setPrefValue(Landroid/preference/ListPreference;Ljava/lang/String;)V
    ...
    .line 137
    :cond_1
    invoke-direct {p0, p2}, Lcom/android/settings/inputmethod/StylusGestures;->getAppName(Ljava/lang/String;)Ljava/lang/CharSequence;
...
.method private setupGesturePref(Ljava/lang/String;Ljava/lang/String;)Landroid/preference/ListPreference;
    ...
    .prologue
    .line 85
    invoke-virtual {p0, p1}, Lcom/android/settings/inputmethod/StylusGestures;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/settings/inputmethod/StylusGestures;->addApplicationEntries(Landroid/preference/ListPreference;Ljava/lang/String;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 71
    iget-object v1, p0, Lcom/android/settings/inputmethod/StylusGestures;->mContext:Landroid/content/Context;
    ...
    iput-object v1, p0, Lcom/android/settings/inputmethod/StylusGestures;->mActionValues:[Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/settings/inputmethod/StylusGestures;->setupGesturePref(Ljava/lang/String;Ljava/lang/String;)Landroid/preference/ListPreference;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lcom/android/settings/inputmethod/StylusGestures;->mSwipeLeft:Landroid/preference/ListPreference;
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/settings/inputmethod/StylusGestures;->setPrefValue(Landroid/preference/ListPreference;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/settings/inputmethod/StylusGestures;->mSwipeRight:Landroid/preference/ListPreference;
    ...
    .line 100
    :cond_1
    iget-object v2, p0, Lcom/android/settings/inputmethod/StylusGestures;->mSwipeUp:Landroid/preference/ListPreference;
    ...
    .line 102
    :cond_2
    iget-object v2, p0, Lcom/android/settings/inputmethod/StylusGestures;->mSwipeDown:Landroid/preference/ListPreference;
    ...
    .line 104
    :cond_3
    iget-object v2, p0, Lcom/android/settings/inputmethod/StylusGestures;->mSwipeLong:Landroid/preference/ListPreference;
    ...
    .line 106
    :cond_4
    iget-object v2, p0, Lcom/android/settings/inputmethod/StylusGestures;->mSwipeDouble:Landroid/preference/ListPreference;
