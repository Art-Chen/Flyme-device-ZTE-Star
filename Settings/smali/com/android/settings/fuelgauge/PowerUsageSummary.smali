...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/fuelgauge/PowerUsageSummary$PerformanceProfileObserver;
    }
.end annotation
...
.field private mPerformanceProfileObserver:Lcom/android/settings/fuelgauge/PowerUsageSummary$PerformanceProfileObserver;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerformanceProfileObserver:Lcom/android/settings/fuelgauge/PowerUsageSummary$PerformanceProfileObserver;
...
.method static synthetic access$100(Lcom/android/settings/fuelgauge/PowerUsageSummary;)V
    ...
    .prologue
    .line 65
    invoke-direct {p0}, Lcom/android/settings/fuelgauge/PowerUsageSummary;->updatePerformanceValue()V

    return-void
.end method

.method static synthetic access$200(Lcom/android/settings/fuelgauge/PowerUsageSummary;)Landroid/content/ContentResolver;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/fuelgauge/PowerUsageSummary;
...
.method static synthetic access$300(Lcom/android/settings/fuelgauge/PowerUsageSummary;)Landroid/os/UserManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/fuelgauge/PowerUsageSummary;
...
.method static synthetic access$400(Lcom/android/settings/fuelgauge/PowerUsageSummary;)Lcom/android/internal/os/BatteryStatsHelper;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/fuelgauge/PowerUsageSummary;
...
.method static synthetic access$500(Lcom/android/settings/fuelgauge/PowerUsageSummary;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/fuelgauge/PowerUsageSummary;
...
.method static synthetic access$600(Lcom/android/settings/fuelgauge/PowerUsageSummary;)Landroid/preference/SwitchPreference;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/fuelgauge/PowerUsageSummary;

    .prologue
    .line 65
    iget-object v0, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mBatterySaverPref:Landroid/preference/SwitchPreference;

    return-object v0
.end method

.method static synthetic access$700(Lcom/android/settings/fuelgauge/PowerUsageSummary;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/fuelgauge/PowerUsageSummary;

    .prologue
    .line 65
    invoke-direct {p0}, Lcom/android/settings/fuelgauge/PowerUsageSummary;->refreshBatterySaverOptions()V
...
.method private refreshBatterySaverOptions()V
    ...
    .line 355
    iget-object v3, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mBatterySaverPref:Landroid/preference/SwitchPreference;

    iget-boolean v0, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mBatteryPluggedIn:Z
    ...
    iget-boolean v3, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mBatteryPluggedIn:Z

    if-nez v3, :cond_2

    iget-object v3, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPowerManager:Landroid/os/PowerManager;
    ...
    .line 357
    iget-object v1, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mBatterySaverPref:Landroid/preference/SwitchPreference;
...
.method private updateBatteryStatus(Landroid/content/Intent;)Z
    ...
    .line 378
    invoke-direct {p0, p1}, Lcom/android/settings/fuelgauge/PowerUsageSummary;->isBatteryPluggedIn(Landroid/content/Intent;)Z

    move-result v2

    iput-boolean v2, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mBatteryPluggedIn:Z
...
.method private updatePerformanceSummary()V
    ...
    .prologue
    .line 393
    iget-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPowerManager:Landroid/os/PowerManager;
    ...
    iget-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfileValues:[Ljava/lang/String;
    ...
    .line 399
    iget-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfileEntries:[Ljava/lang/String;
    ...
    .line 405
    :cond_1
    iget-object v4, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfilePref:Landroid/preference/ListPreference;
...
.method private updatePerformanceValue()V
    ...
    .prologue
    .line 409
    iget-object v0, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfilePref:Landroid/preference/ListPreference;
    ...
    iget-object v1, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPowerManager:Landroid/os/PowerManager;
    ...
    .line 413
    invoke-direct {p0}, Lcom/android/settings/fuelgauge/PowerUsageSummary;->updatePerformanceSummary()V
...
.method public onAttach(Landroid/app/Activity;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/fuelgauge/PowerUsageSummary;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/os/PowerManager;

    iput-object v0, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPowerManager:Landroid/os/PowerManager;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfileEntries:[Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfileValues:[Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfilePref:Landroid/preference/ListPreference;
    ...
    iput-object v0, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mBatterySaverPref:Landroid/preference/SwitchPreference;
    ...
    iget-object v0, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPowerManager:Landroid/os/PowerManager;
    ...
    .line 161
    iput-object v2, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfilePref:Landroid/preference/ListPreference;

    .line 173
    :cond_0
    :goto_0
    new-instance v0, Lcom/android/settings/fuelgauge/PowerUsageSummary$PerformanceProfileObserver;

    new-instance v1, Landroid/os/Handler;

    invoke-direct {v1}, Landroid/os/Handler;-><init>()V

    invoke-direct {v0, p0, v1}, Lcom/android/settings/fuelgauge/PowerUsageSummary$PerformanceProfileObserver;-><init>(Lcom/android/settings/fuelgauge/PowerUsageSummary;Landroid/os/Handler;)V
    ...
    .line 165
    iput-object v2, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mBatterySaverPref:Landroid/preference/SwitchPreference;
    ...
    iget-object v1, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfileEntries:[Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfileValues:[Ljava/lang/String;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    iput v9, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mStatsType:I
    ...
    .line 304
    :pswitch_1
    iget-object v9, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mStatsHelper:Lcom/android/internal/os/BatteryStatsHelper;
    ...
    .line 306
    iget-object v9, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mHandler:Landroid/os/Handler;
    ...
    new-instance v10, Lcom/android/settings/fuelgauge/PowerUsageSummary$2;

    invoke-direct {v10, p0, v3}, Lcom/android/settings/fuelgauge/PowerUsageSummary$2;-><init>(Lcom/android/settings/fuelgauge/PowerUsageSummary;[I)V
...
.method public onPause()V
    ...
    iget-object v2, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mBatteryInfoReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 212
    iget-object v1, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerfProfilePref:Landroid/preference/ListPreference;
    ...
    iget-object v1, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerformanceProfileObserver:Lcom/android/settings/fuelgauge/PowerUsageSummary$PerformanceProfileObserver;
...
.method public onResume()V
    ...
    invoke-direct {p0, v1}, Lcom/android/settings/fuelgauge/PowerUsageSummary;->updateBatteryStatus(Landroid/content/Intent;)Z
    ...
    iget-object v3, p0, Lcom/android/settings/fuelgauge/PowerUsageSummary;->mPerformanceProfileObserver:Lcom/android/settings/fuelgauge/PowerUsageSummary$PerformanceProfileObserver;
