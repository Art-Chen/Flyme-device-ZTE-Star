...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 734
    new-instance v0, Lcom/android/settings/ButtonSettings$2;

    invoke-direct {v0}, Lcom/android/settings/ButtonSettings$2;-><init>()V

    sput-object v0, Lcom/android/settings/ButtonSettings;->SEARCH_INDEX_DATA_PROVIDER:Lcom/android/settings/search/Indexable$SearchIndexProvider;
...
.method static synthetic access$000(Lcom/android/settings/ButtonSettings;)Landroid/preference/SwitchPreference;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/ButtonSettings;

    .prologue
    .line 59
    iget-object v0, p0, Lcom/android/settings/ButtonSettings;->mDisableNavigationKeys:Landroid/preference/SwitchPreference;

    return-object v0
.end method

.method static synthetic access$100(Lcom/android/settings/ButtonSettings;)Landroid/preference/PreferenceCategory;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/ButtonSettings;

    .prologue
    .line 59
    iget-object v0, p0, Lcom/android/settings/ButtonSettings;->mNavigationPreferencesCat:Landroid/preference/PreferenceCategory;

    return-object v0
.end method

.method static synthetic access$200(Lcom/android/settings/ButtonSettings;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/ButtonSettings;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 59
    invoke-direct {p0, p1}, Lcom/android/settings/ButtonSettings;->updateDisableNavkeysCategories(Z)V

    return-void
.end method

.method static synthetic access$300(Lcom/android/settings/ButtonSettings;Landroid/content/Context;)Ljava/util/Map;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/ButtonSettings;
    ...
    .prologue
    .line 59
    invoke-static {p0, p1}, Lcom/android/settings/ButtonSettings;->getPreferencesToRemove(Lcom/android/settings/ButtonSettings;Landroid/content/Context;)Ljava/util/Map;
...
.method private static getPreferencesToRemove(Lcom/android/settings/ButtonSettings;Landroid/content/Context;)Ljava/util/Map;
    .locals 33
    .param p0, "settings"    # Lcom/android/settings/ButtonSettings;
    .param p1, "context"    # Landroid/content/Context;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/android/settings/ButtonSettings;",
    ...
    iput-object v0, v1, Lcom/android/settings/ButtonSettings;->mPowerEndCall:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/ButtonSettings;->mHomeAnswerCall:Landroid/preference/SwitchPreference;
    ...
    invoke-direct {v0, v1, v8}, Lcom/android/settings/ButtonSettings;->initActionList(Ljava/lang/String;I)Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/ButtonSettings;->mAssistPressAction:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/ButtonSettings;->mAssistLongPressAction:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/ButtonSettings;->mAppSwitchPressAction:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/ButtonSettings;->mAppSwitchLongPressAction:Landroid/preference/ListPreference;
    ...
    :cond_10
    :goto_13
    invoke-static/range {p1 .. p1}, Lcom/android/settings/Utils;->hasVolumeRocker(Landroid/content/Context;)Z
    ...
    :cond_15
    :goto_17
    invoke-static/range {p1 .. p1}, Lcom/android/settings/cyanogenmod/ButtonBacklightBrightness;->isButtonSupported(Landroid/content/Context;)Z

    move-result v31

    if-nez v31, :cond_16

    invoke-static/range {p1 .. p1}, Lcom/android/settings/cyanogenmod/ButtonBacklightBrightness;->isKeyboardSupported(Landroid/content/Context;)Z
    ...
    .line 259
    invoke-direct/range {p0 .. p0}, Lcom/android/settings/ButtonSettings;->updateDisableNavkeysOption()V

    .line 260
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings/ButtonSettings;->mNavigationPreferencesCat:Landroid/preference/PreferenceCategory;

    move-object/from16 v31, v0

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings/ButtonSettings;->mDisableNavigationKeys:Landroid/preference/SwitchPreference;
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/ButtonSettings;->updateDisableNavkeysCategories(Z)V
...
.method private handleToggleHomeButtonAnswersCallPreferenceClick()V
    ...
    iget-object v0, p0, Lcom/android/settings/ButtonSettings;->mHomeAnswerCall:Landroid/preference/SwitchPreference;
...
.method private handleTogglePowerButtonEndsCallPreferenceClick()V
    ...
    iget-object v0, p0, Lcom/android/settings/ButtonSettings;->mPowerEndCall:Landroid/preference/SwitchPreference;
...
.method private initRecentsLongPressAction(Ljava/lang/String;)Landroid/preference/ListPreference;
    ...
    .line 471
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings/ButtonSettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    invoke-virtual {v0, v14}, Lcom/android/settings/ButtonSettings;->getString(I)Ljava/lang/String;
    ...
    .line 482
    :goto_0
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings/ButtonSettings;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    invoke-virtual {v0, v15}, Lcom/android/settings/ButtonSettings;->getString(I)Ljava/lang/String;
...
.method public static restoreKeyDisabler(Landroid/content/Context;)V
    ...
    :cond_1
    invoke-static {p0, v1}, Lcom/android/settings/ButtonSettings;->writeDisableNavkeysOption(Landroid/content/Context;Z)V
...
.method private updateDisableNavkeysCategories(Z)V
    ...
    check-cast v3, Lcom/android/settings/cyanogenmod/ButtonBacklightBrightness;

    .line 653
    .local v3, "backlight":Lcom/android/settings/cyanogenmod/ButtonBacklightBrightness;
    if-eqz v3, :cond_0
    ...
    :goto_0
    invoke-virtual {v3, v7}, Lcom/android/settings/cyanogenmod/ButtonBacklightBrightness;->setEnabled(Z)V

    .line 655
    invoke-virtual {v3}, Lcom/android/settings/cyanogenmod/ButtonBacklightBrightness;->updateSummary()V
...
.method private updateDisableNavkeysOption()V
    ...
    .line 628
    invoke-virtual {p0}, Lcom/android/settings/ButtonSettings;->getActivity()Landroid/app/Activity;
    ...
    .local v0, "enabled":Z
    :cond_0
    iget-object v1, p0, Lcom/android/settings/ButtonSettings;->mDisableNavigationKeys:Landroid/preference/SwitchPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v9}, Lcom/android/settings/ButtonSettings;->addPreferencesFromResource(I)V
    ...
    invoke-virtual {p0, v9}, Lcom/android/settings/ButtonSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v9

    check-cast v9, Landroid/preference/SwitchPreference;

    iput-object v9, p0, Lcom/android/settings/ButtonSettings;->mPowerEndCall:Landroid/preference/SwitchPreference;
    ...
    iput-object v9, p0, Lcom/android/settings/ButtonSettings;->mHomeAnswerCall:Landroid/preference/SwitchPreference;
    ...
    iput-object v9, p0, Lcom/android/settings/ButtonSettings;->mHandler:Landroid/os/Handler;
    ...
    iput-object v9, p0, Lcom/android/settings/ButtonSettings;->mDisableNavigationKeys:Landroid/preference/SwitchPreference;
    ...
    iput-object v9, p0, Lcom/android/settings/ButtonSettings;->mNavigationPreferencesCat:Landroid/preference/PreferenceCategory;
    ...
    iput-object v9, p0, Lcom/android/settings/ButtonSettings;->mNavigationBarLeftPref:Landroid/preference/SwitchPreference;

    .line 162
    const-string v9, "navigation_recents_long_press"

    invoke-direct {p0, v9}, Lcom/android/settings/ButtonSettings;->initRecentsLongPressAction(Ljava/lang/String;)Landroid/preference/ListPreference;

    move-result-object v9

    iput-object v9, p0, Lcom/android/settings/ButtonSettings;->mNavigationRecentsLongPressAction:Landroid/preference/ListPreference;
    ...
    invoke-static {p0, v9}, Lcom/android/settings/ButtonSettings;->getPreferencesToRemove(Lcom/android/settings/ButtonSettings;Landroid/content/Context;)Ljava/util/Map;
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings/ButtonSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    .line 172
    invoke-virtual {p0, v0}, Lcom/android/settings/ButtonSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    :cond_1
    invoke-virtual {p0, v3}, Lcom/android/settings/ButtonSettings;->removePreference(Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lcom/android/settings/Utils;->hasVolumeRocker(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, v9, v1}, Lcom/android/settings/ButtonSettings;->initActionList(Ljava/lang/String;I)Landroid/preference/ListPreference;

    move-result-object v9

    iput-object v9, p0, Lcom/android/settings/ButtonSettings;->mVolumeKeyCursorControl:Landroid/preference/ListPreference;
    ...
    iput-object v9, p0, Lcom/android/settings/ButtonSettings;->mSwapVolumeButtons:Landroid/preference/SwitchPreference;

    .line 194
    iget-object v9, p0, Lcom/android/settings/ButtonSettings;->mSwapVolumeButtons:Landroid/preference/SwitchPreference;

    if-eqz v9, :cond_3

    .line 195
    iget-object v12, p0, Lcom/android/settings/ButtonSettings;->mSwapVolumeButtons:Landroid/preference/SwitchPreference;
    ...
    :cond_3
    iget-object v9, p0, Lcom/android/settings/ButtonSettings;->mNavigationPreferencesCat:Landroid/preference/PreferenceCategory;
    ...
    iput-object v9, p0, Lcom/android/settings/ButtonSettings;->mVolumeWakeScreen:Landroid/preference/SwitchPreference;
    ...
    iput-object v9, p0, Lcom/android/settings/ButtonSettings;->mVolumeMusicControls:Landroid/preference/SwitchPreference;

    .line 207
    iget-object v9, p0, Lcom/android/settings/ButtonSettings;->mVolumeWakeScreen:Landroid/preference/SwitchPreference;

    if-eqz v9, :cond_5

    .line 208
    iget-object v9, p0, Lcom/android/settings/ButtonSettings;->mVolumeMusicControls:Landroid/preference/SwitchPreference;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 540
    iget-object v4, p0, Lcom/android/settings/ButtonSettings;->mHomeLongPressAction:Landroid/preference/ListPreference;
    ...
    invoke-direct {p0, v4, p2, v5}, Lcom/android/settings/ButtonSettings;->handleActionListChange(Landroid/preference/ListPreference;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 544
    :cond_0
    iget-object v4, p0, Lcom/android/settings/ButtonSettings;->mHomeDoubleTapAction:Landroid/preference/ListPreference;
    ...
    .line 548
    :cond_1
    iget-object v4, p0, Lcom/android/settings/ButtonSettings;->mMenuPressAction:Landroid/preference/ListPreference;
    ...
    .line 552
    :cond_2
    iget-object v4, p0, Lcom/android/settings/ButtonSettings;->mMenuLongPressAction:Landroid/preference/ListPreference;
    ...
    .line 556
    :cond_3
    iget-object v4, p0, Lcom/android/settings/ButtonSettings;->mAssistPressAction:Landroid/preference/ListPreference;
    ...
    .line 560
    :cond_4
    iget-object v4, p0, Lcom/android/settings/ButtonSettings;->mAssistLongPressAction:Landroid/preference/ListPreference;
    ...
    .line 564
    :cond_5
    iget-object v4, p0, Lcom/android/settings/ButtonSettings;->mAppSwitchPressAction:Landroid/preference/ListPreference;
    ...
    .line 568
    :cond_6
    iget-object v4, p0, Lcom/android/settings/ButtonSettings;->mAppSwitchLongPressAction:Landroid/preference/ListPreference;
    ...
    .line 572
    :cond_7
    iget-object v4, p0, Lcom/android/settings/ButtonSettings;->mVolumeKeyCursorControl:Landroid/preference/ListPreference;
    ...
    .line 576
    :cond_8
    iget-object v4, p0, Lcom/android/settings/ButtonSettings;->mNavigationRecentsLongPressAction:Landroid/preference/ListPreference;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 690
    iget-object v2, p0, Lcom/android/settings/ButtonSettings;->mSwapVolumeButtons:Landroid/preference/SwitchPreference;
    ...
    .line 695
    :cond_3
    iget-object v2, p0, Lcom/android/settings/ButtonSettings;->mDisableNavigationKeys:Landroid/preference/SwitchPreference;
    ...
    .line 697
    iget-object v2, p0, Lcom/android/settings/ButtonSettings;->mNavigationPreferencesCat:Landroid/preference/PreferenceCategory;
    ...
    invoke-static {v1, v2}, Lcom/android/settings/ButtonSettings;->writeDisableNavkeysOption(Landroid/content/Context;Z)V

    .line 699
    invoke-direct {p0}, Lcom/android/settings/ButtonSettings;->updateDisableNavkeysOption()V

    .line 700
    invoke-direct {p0, v0}, Lcom/android/settings/ButtonSettings;->updateDisableNavkeysCategories(Z)V

    .line 701
    iget-object v1, p0, Lcom/android/settings/ButtonSettings;->mHandler:Landroid/os/Handler;

    new-instance v2, Lcom/android/settings/ButtonSettings$1;

    invoke-direct {v2, p0}, Lcom/android/settings/ButtonSettings$1;-><init>(Lcom/android/settings/ButtonSettings;)V
    ...
    .line 709
    :cond_4
    iget-object v1, p0, Lcom/android/settings/ButtonSettings;->mPowerEndCall:Landroid/preference/SwitchPreference;

    if-ne p2, v1, :cond_5

    .line 710
    invoke-direct {p0}, Lcom/android/settings/ButtonSettings;->handleTogglePowerButtonEndsCallPreferenceClick()V

    goto :goto_2

    .line 712
    :cond_5
    iget-object v1, p0, Lcom/android/settings/ButtonSettings;->mHomeAnswerCall:Landroid/preference/SwitchPreference;

    if-ne p2, v1, :cond_1

    .line 713
    invoke-direct {p0}, Lcom/android/settings/ButtonSettings;->handleToggleHomeButtonAnswersCallPreferenceClick()V
...
.method public onResume()V
    ...
    .line 436
    iget-object v6, p0, Lcom/android/settings/ButtonSettings;->mPowerEndCall:Landroid/preference/SwitchPreference;
    ...
    :cond_0
    iget-object v6, p0, Lcom/android/settings/ButtonSettings;->mHomeAnswerCall:Landroid/preference/SwitchPreference;
    ...
    :goto_1
    iget-object v4, p0, Lcom/android/settings/ButtonSettings;->mHomeAnswerCall:Landroid/preference/SwitchPreference;
