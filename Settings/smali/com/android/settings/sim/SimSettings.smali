...
.method static synthetic access$500(Lcom/android/settings/sim/SimSettings;)Ljava/util/List;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/sim/SimSettings;
...
.method private createPreferences()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings/sim/SimSettings;->addPreferencesFromResource(I)V
    ...
    iput-object v3, p0, Lcom/android/settings/sim/SimSettings;->mPrimarySubSelect:Landroid/preference/Preference;
    ...
    iput-object v3, p0, Lcom/android/settings/sim/SimSettings;->mAvailableSubInfos:Ljava/util/List;
    ...
    sput-object v3, Lcom/android/settings/sim/SimSettings;->mSimEnablers:Ljava/util/List;
    ...
    .local v0, "i":I
    :goto_0
    sget v3, Lcom/android/settings/sim/SimSettings;->mNumSlots:I
    ...
    .line 198
    sget-object v3, Lcom/android/settings/sim/SimSettings;->mSimEnablers:Ljava/util/List;

    new-instance v4, Lcom/android/settings/sim/MultiSimEnablerPreference;

    invoke-virtual {p0}, Lcom/android/settings/sim/SimSettings;->getActivity()Landroid/app/Activity;

    move-result-object v5

    iget-object v6, p0, Lcom/android/settings/sim/SimSettings;->mHandler:Landroid/os/Handler;

    invoke-direct {v4, v5, v2, v6, v0}, Lcom/android/settings/sim/MultiSimEnablerPreference;-><init>(Landroid/content/Context;Landroid/telephony/SubscriptionInfo;Landroid/os/Handler;I)V
    ...
    iput v3, p0, Lcom/android/settings/sim/SimSettings;->mNumSims:I
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings/sim/SimSettings;->removePreference(Ljava/lang/String;)V
