...
.method private initPPService()V
    ...
    .prologue
    .line 231
    new-instance v5, Lcom/android/settings/CustomScreenColor$PPServiceConnection;

    const/4 v6, 0x0

    invoke-direct {v5, p0, v6}, Lcom/android/settings/CustomScreenColor$PPServiceConnection;-><init>(Lcom/android/settings/CustomScreenColor;Lcom/android/settings/CustomScreenColor$1;)V

    iput-object v5, p0, Lcom/android/settings/CustomScreenColor;->mPPServiceConn:Lcom/android/settings/CustomScreenColor$PPServiceConnection;
    ...
    .line 239
    iget-object v5, p0, Lcom/android/settings/CustomScreenColor;->mPPServiceConn:Lcom/android/settings/CustomScreenColor$PPServiceConnection;

    const/4 v6, 0x1

    invoke-virtual {p0, v1, v5, v6}, Lcom/android/settings/CustomScreenColor;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
...
.method private setActivated(Landroid/widget/SeekBar;Z)V
    ...
    .sparse-switch
        ...
        0x7f10007e -> :sswitch_1
        0x7f100082 -> :sswitch_3
        0x7f100087 -> :sswitch_2
    .end sparse-switch
.end method
...
.method public onProgressChanged(Landroid/widget/SeekBar;IZ)V
    ...
    iget v5, p0, Lcom/android/settings/CustomScreenColor;->mHueValue:I
    ...
    iget v5, p0, Lcom/android/settings/CustomScreenColor;->mSaturationValue:I
    ...
    .line 380
    :try_start_0
    iget-object v3, p0, Lcom/android/settings/CustomScreenColor;->mPPService:Lcom/android/display/IPPService;
    ...
    iget v6, p0, Lcom/android/settings/CustomScreenColor;->mIntensityValue:I

    iget v7, p0, Lcom/android/settings/CustomScreenColor;->mContrastValue:I
    ...
    .sparse-switch
        0x7f10007a -> :sswitch_0
        0x7f10007e -> :sswitch_1
        0x7f100082 -> :sswitch_2
        0x7f100087 -> :sswitch_3
    .end sparse-switch
.end method
