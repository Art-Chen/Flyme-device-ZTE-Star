...
.method static synthetic access$100(Lcom/android/settings/DisplaySettings;)V
    ...
    .prologue
    .line 70
    invoke-direct {p0}, Lcom/android/settings/DisplaySettings;->updateAccelerometerRotationSwitch()V

    return-void
.end method

.method static synthetic access$200(Lcom/android/settings/DisplaySettings;)Lcom/android/settings/FontDialogPreference;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/DisplaySettings;
...
.method private updateState()V
    ...
    .line 422
    iget-object v2, p0, Lcom/android/settings/DisplaySettings;->mFontSizePref:Lcom/android/settings/FontDialogPreference;

    invoke-virtual {p0, v2}, Lcom/android/settings/DisplaySettings;->readFontSizePreference(Landroid/preference/Preference;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v8, p0, Lcom/android/settings/DisplaySettings;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;
    ...
    iput-object v8, p0, Lcom/android/settings/DisplaySettings;->mDisplayRotationPreference:Landroid/preference/PreferenceScreen;
    ...
    iput-object v8, p0, Lcom/android/settings/DisplaySettings;->mAccelerometer:Landroid/preference/SwitchPreference;
    ...
    check-cast v8, Lcom/android/settings/FontDialogPreference;

    iput-object v8, p0, Lcom/android/settings/DisplaySettings;->mFontSizePref:Lcom/android/settings/FontDialogPreference;

    .line 166
    iget-object v8, p0, Lcom/android/settings/DisplaySettings;->mFontSizePref:Lcom/android/settings/FontDialogPreference;

    invoke-virtual {v8, p0}, Lcom/android/settings/FontDialogPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V

    .line 167
    iget-object v8, p0, Lcom/android/settings/DisplaySettings;->mFontSizePref:Lcom/android/settings/FontDialogPreference;

    invoke-virtual {v8, p0}, Lcom/android/settings/FontDialogPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
    ...
    iput-object v8, p0, Lcom/android/settings/DisplaySettings;->mTapToWake:Landroid/preference/SwitchPreference;

    .line 199
    if-eqz v1, :cond_5

    iget-object v8, p0, Lcom/android/settings/DisplaySettings;->mTapToWake:Landroid/preference/SwitchPreference;

    if-eqz v8, :cond_5

    iget-object v8, p0, Lcom/android/settings/DisplaySettings;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;
    ...
    .line 202
    iput-object v12, p0, Lcom/android/settings/DisplaySettings;->mTapToWake:Landroid/preference/SwitchPreference;
    ...
    iput-object v8, p0, Lcom/android/settings/DisplaySettings;->mWakeWhenPluggedOrUnplugged:Landroid/preference/SwitchPreference;
    ...
    invoke-direct {p0, v8}, Lcom/android/settings/DisplaySettings;->initPulse(Landroid/preference/PreferenceCategory;)V
    ...
    .line 175
    iput-object v12, p0, Lcom/android/settings/DisplaySettings;->mAutoBrightnessPreference:Landroid/preference/SwitchPreference;
    ...
    .line 185
    iput-object v12, p0, Lcom/android/settings/DisplaySettings;->mLiftToWakePreference:Landroid/preference/SwitchPreference;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 496
    iget-object v2, p0, Lcom/android/settings/DisplaySettings;->mTapToWake:Landroid/preference/SwitchPreference;

    if-ne p2, v2, :cond_0

    .line 497
    iget-object v0, p0, Lcom/android/settings/DisplaySettings;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;
    ...
    .line 498
    :cond_0
    iget-object v2, p0, Lcom/android/settings/DisplaySettings;->mWakeWhenPluggedOrUnplugged:Landroid/preference/SwitchPreference;
    ...
    iget-object v4, p0, Lcom/android/settings/DisplaySettings;->mWakeWhenPluggedOrUnplugged:Landroid/preference/SwitchPreference;
    ...
    .line 503
    :cond_2
    iget-object v2, p0, Lcom/android/settings/DisplaySettings;->mAccelerometer:Landroid/preference/SwitchPreference;
...
.method public onResume()V
    ...
    iget-object v5, p0, Lcom/android/settings/DisplaySettings;->mCmHardwareManager:Landroid/hardware/CmHardwareManager;
    ...
    .line 387
    iget-object v5, p0, Lcom/android/settings/DisplaySettings;->mWakeWhenPluggedOrUnplugged:Landroid/preference/SwitchPreference;
