...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mContext:Landroid/content/Context;
    ...
    sget-boolean v11, Lcom/android/settings/notification/AppNotificationSettings;->DEBUG:Z
    ...
    invoke-static {v7, v6, v10}, Lcom/android/settings/notification/AppNotificationSettings;->findPackageInfo(Landroid/content/pm/PackageManager;Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-virtual {p0, v11}, Lcom/android/settings/notification/AppNotificationSettings;->addPreferencesFromResource(I)V

    .line 140
    const-string v11, "block"

    invoke-virtual {p0, v11}, Lcom/android/settings/notification/AppNotificationSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v11

    check-cast v11, Landroid/preference/SwitchPreference;

    iput-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mBlock:Landroid/preference/SwitchPreference;
    ...
    iput-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mPriority:Landroid/preference/SwitchPreference;
    ...
    iput-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mSensitive:Landroid/preference/SwitchPreference;
    ...
    iput-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowOnKeyguard:Landroid/preference/SwitchPreference;
    ...
    iput-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowNoOngoingOnKeyguard:Landroid/preference/SwitchPreference;
    ...
    iget-object v12, p0, Lcom/android/settings/notification/AppNotificationSettings;->mSensitive:Landroid/preference/SwitchPreference;
    ...
    iget-object v12, p0, Lcom/android/settings/notification/AppNotificationSettings;->mBackend:Lcom/android/settings/notification/NotificationAppList$Backend;

    invoke-static {v7, v11, v12}, Lcom/android/settings/notification/NotificationAppList;->loadAppRow(Landroid/content/pm/PackageManager;Landroid/content/pm/ApplicationInfo;Lcom/android/settings/notification/NotificationAppList$Backend;)Lcom/android/settings/notification/NotificationAppList$AppRow;

    move-result-object v11

    iput-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mAppRow:Lcom/android/settings/notification/NotificationAppList$AppRow;
    ...
    .line 157
    iget-object v12, p0, Lcom/android/settings/notification/AppNotificationSettings;->mAppRow:Lcom/android/settings/notification/NotificationAppList$AppRow;
    ...
    iput-object v11, v12, Lcom/android/settings/notification/NotificationAppList$AppRow;->settingsIntent:Landroid/content/Intent;

    .line 166
    :cond_9
    :goto_1
    iget-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mBlock:Landroid/preference/SwitchPreference;

    iget-object v12, p0, Lcom/android/settings/notification/AppNotificationSettings;->mAppRow:Lcom/android/settings/notification/NotificationAppList$AppRow;

    iget-boolean v12, v12, Lcom/android/settings/notification/NotificationAppList$AppRow;->banned:Z

    invoke-virtual {v11, v12}, Landroid/preference/SwitchPreference;->setChecked(Z)V

    .line 167
    iget-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mPriority:Landroid/preference/SwitchPreference;

    iget-object v12, p0, Lcom/android/settings/notification/AppNotificationSettings;->mAppRow:Lcom/android/settings/notification/NotificationAppList$AppRow;

    iget-boolean v12, v12, Lcom/android/settings/notification/NotificationAppList$AppRow;->priority:Z

    invoke-virtual {v11, v12}, Landroid/preference/SwitchPreference;->setChecked(Z)V

    .line 168
    iget-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mSensitive:Landroid/preference/SwitchPreference;
    ...
    iget-boolean v12, v12, Lcom/android/settings/notification/NotificationAppList$AppRow;->sensitive:Z
    ...
    new-instance v12, Lcom/android/settings/notification/AppNotificationSettings$2;

    invoke-direct {v12, p0, v6, v10}, Lcom/android/settings/notification/AppNotificationSettings$2;-><init>(Lcom/android/settings/notification/AppNotificationSettings;Ljava/lang/String;I)V
    ...
    new-instance v12, Lcom/android/settings/notification/AppNotificationSettings$3;

    invoke-direct {v12, p0, v6, v10}, Lcom/android/settings/notification/AppNotificationSettings$3;-><init>(Lcom/android/settings/notification/AppNotificationSettings;Ljava/lang/String;I)V
    ...
    new-instance v12, Lcom/android/settings/notification/AppNotificationSettings$4;

    invoke-direct {v12, p0, v6, v10}, Lcom/android/settings/notification/AppNotificationSettings$4;-><init>(Lcom/android/settings/notification/AppNotificationSettings;Ljava/lang/String;I)V

    invoke-virtual {v11, v12}, Landroid/preference/SwitchPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V

    .line 198
    :cond_b
    iget-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mBackend:Lcom/android/settings/notification/NotificationAppList$Backend;

    invoke-virtual {v11, v6, v10}, Lcom/android/settings/notification/NotificationAppList$Backend;->getShowNotificationForPackageOnKeyguard(Ljava/lang/String;I)I

    move-result v5

    .line 199
    .local v5, "keyguard":I
    iget-object v12, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowOnKeyguard:Landroid/preference/SwitchPreference;
    ...
    .line 200
    iget-object v12, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowNoOngoingOnKeyguard:Landroid/preference/SwitchPreference;
    ...
    .line 203
    iget-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowOnKeyguard:Landroid/preference/SwitchPreference;

    new-instance v12, Lcom/android/settings/notification/AppNotificationSettings$5;

    invoke-direct {v12, p0, v6, v10}, Lcom/android/settings/notification/AppNotificationSettings$5;-><init>(Lcom/android/settings/notification/AppNotificationSettings;Ljava/lang/String;I)V

    invoke-virtual {v11, v12}, Landroid/preference/SwitchPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V

    .line 218
    iget-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mShowNoOngoingOnKeyguard:Landroid/preference/SwitchPreference;

    new-instance v12, Lcom/android/settings/notification/AppNotificationSettings$6;

    invoke-direct {v12, p0, v6, v10}, Lcom/android/settings/notification/AppNotificationSettings$6;-><init>(Lcom/android/settings/notification/AppNotificationSettings;Ljava/lang/String;I)V
    ...
    iget-object v12, p0, Lcom/android/settings/notification/AppNotificationSettings;->mBlock:Landroid/preference/SwitchPreference;
    ...
    .line 162
    .local v8, "rows":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/settings/notification/NotificationAppList$AppRow;>;"
    iget-object v11, p0, Lcom/android/settings/notification/AppNotificationSettings;->mAppRow:Lcom/android/settings/notification/NotificationAppList$AppRow;

    iget-object v11, v11, Lcom/android/settings/notification/NotificationAppList$AppRow;->pkg:Ljava/lang/String;
    ...
    invoke-static {v11, v8}, Lcom/android/settings/notification/NotificationAppList;->collectConfigActivities(Landroid/content/pm/PackageManager;Landroid/util/ArrayMap;)V

    goto/16 :goto_1

    .line 199
    .end local v8    # "rows":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/settings/notification/NotificationAppList$AppRow;>;"
